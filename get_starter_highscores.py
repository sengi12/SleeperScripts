...
def get_starter_highscores(league_id):
    highest_scores = {}
    highest_score_weeks = {}
                ...
                for match in matchups:
                    ...
                    for player_id in match["starters"]:
                        if player_id not in match['players_points']:
                            ...
                            pass
                        elif match["players_points"][player_id] > highest_scores[roster_id]:
                            highest_scores[roster_id] = match["players_points"][player_id]
                            highest_score_weeks[roster_id] = week
                            player = get_player(player_id)
                            highest_score_players[roster_id] = f"{player['first_name']} {player['last_name']}"
    ...
    for roster_id in current_users:
        print(f"{current_users[roster_id]}: \n\t{highest_score_players[roster_id]}: {highest_scores[roster_id]}\n\tWeek {highest_score_weeks[roster_id]} in {highest_score_years[roster_id]}")
...
get_starter_highscores(league_id)
